  ...
  return (
    ...
    >
      ...
      <div className="mt-20 relative z-10 container mx-auto px-4 text-center">
        ...
        >
          <p className="text-sm md:text-base lg:text-lg text-new-white  ">
            {" "}
            {/* Text color updated */}
            I'm a passionate web developer, expert in creating beautiful,
            responsive, and user-friendly web applications. Specializing in
            React and modern JavaScript, I love turning complex problems into
