...
const projects = [
  ...
  },
  {
    ...
    gitlink: "https://github.com/Usman-99/TodoList-Created-Using-Redux-Toolkit",
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="py-20 bg-gradient-to-br from-col1 via-col2 to-col3 animate-gradient-x"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-new-white">
                  {project.name}
                </h3>
