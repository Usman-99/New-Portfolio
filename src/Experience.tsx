...
const experiences = [
  ...
  {company:"NED University of Engineering and Technology",
    ...
    description: "I graduated with a Bachelor of Engineering in Computer and Information Systems Engineering from NED University with CGPA of 3.564",
  },
  {company:"MCB Funds",
    position:"Web Developer Intern",
    duration: "September 2022 - October 2022",
    description: "I completed a web development internship at MCB Funds, where I gained invaluable experience in understanding the MVC (Model-View-Controller) structure and its application in real-world scenarios. During this internship, I had the opportunity to witness firsthand how financial transactions are managed by banks through web and mobile applications.",
  },
  {company:"KDA",
    position:"IT Intern",
    duration:"March 2023 - April 2023",
    description: "I have done internship at the Karachi Development Authority (KDA), where I gained hands-on experience in understanding server architecture and its functionalities. During this internship, I had the opportunity to delve into the complexities of database management systems and witnessed firsthand how a government organization efficiently manages city property details through systematic database management.",
  },
  {
    company:"Adamjee Government Science College",
    position: 'Intermediate in Pre Engineering',
    duration: "July 2018 - June 2020",
    description: "I graduated from Adamjee Government Science College with a remarkable percentage of 89.91%. Additionally, I was honored to be among the top 20 position holders in the HSC BIEK results.",
  },
...
export default function Experience() {
  return (
    <section id="experience" className="py-20 bg-gradient-to-br from-col4 via-col2 to-col5 animate-gradient-x ">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            ...
            >
              <h3 className="text-2xl font-semibold mb-2 text-white">{exp.position}</h3>
